...
def test_send_empty_form():
    ...
    with allure.step('Check validation on the form'):
        form.check_invalid_controls(control='#firstName')
        form.check_invalid_controls(control='#lastName')
        form.check_invalid_controls(control='#userNumber')
